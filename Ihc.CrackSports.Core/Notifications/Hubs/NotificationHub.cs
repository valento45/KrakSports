	...
	public class NotificationHub : Hub
	{
		...
		public async Task AceitarSolicitacaoAluno(long idClub, long idAluno)
		{
			...
			else
			{
				...
				///Informar cliente em tempo Real
				var cliente = await _alunoCommand.GetById(idAluno);
				await Clients.User(cliente.Usuario.UserName).SendAsync("refreshNotification", "Solicitação aceita pelo Clube", "", "");
			}
